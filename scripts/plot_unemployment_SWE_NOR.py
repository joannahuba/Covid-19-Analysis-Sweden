...
title = 'Unemployment Rate in Sweden and other Nordic Countries'
x_label = 'Year'
...
for i, country in enumerate(nordic_countries):
    ax.plot(unemployment['year'].unique(), unemployment[unemployment['Country Name'] == country]['Unemployment Rate'], label = country, color=colors[i])
