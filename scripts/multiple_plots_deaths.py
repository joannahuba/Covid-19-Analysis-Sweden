...
fig.text(-0.08, 0.5, 'deaths', va='center', rotation='vertical', fontsize=23)
fig.text(0.0, 1.06, 'Confirmed COVID-19 deaths per 1 mln People in the Nordic Region', va='center', rotation='horizontal', fontsize=32)
